...
class DrawingView: UIView {
    ...
    private var blockColor: CGColor = UIColor(red: 0.0, green: 0.0, blue: 0.5, alpha: 0.12).cgColor
    private var lineColor: CGColor = UIColor(red: 0.0, green: 0.0, blue: 0.5, alpha: 0.18).cgColor
    private var elementColor: CGColor = UIColor(red: 0.0, green: 0.0, blue: 0.5, alpha: 0.23).cgColor
